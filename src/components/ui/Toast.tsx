...
function ToastView({ item, onDismiss }: { item: ToastItem; onDismiss: () => void }) {
  ...
  return (
    <div role={item.tone === 'error' ? 'alert' : 'status'} className={cn('pointer-events-auto flex items-start gap-3 rounded-xl glass border border-border float-shadow p-3.5 animate-fade-up')}>
